...
public class IntRange {
    ...
    /// Метод Преобразования ИнтРендж(целые числа)  в Рендж(дроби)
    public static Range range(IntRange range) {
    ...
    {
        if ((range1.getMin() == range2.getMin()) && (range1.getMax() == range2.getMax())) {
            return true;
        } else return false;
    }
     /* public static boolean operator(IntRange range1, IntRange range2) {
...
/*    //@Override
    ...
    public boolean equals(Object o) {
        ...
        Range range = (Range) o;
        return Float.compare(range.getMin(), min) == 0 &&
                Float.compare(range.getMax(), max) == 0;
    }
